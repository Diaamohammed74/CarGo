                                    ...
                                    @foreach ($specializations as $specialization)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <form action="{{ route('dashboard.specializations.destroy', $specialization->id) }}" method="POST" id="deleteForm" style="display:inline;">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="button" class="btn btn-danger btn-sm delete-btn" onclick="confirmDelete('deleteForm', 'You will not be able to recover this specialization!');">
