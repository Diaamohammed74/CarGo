                                ...
                                <div class="dropdown-menu dropdown-menu-end" style="">
                                    <div class="card border-0 mb-0">
                                        <div class="card-header py-2">
                                            <div class="products">
                                                <img src="{{ asset('images/user.jpg') }}" class="avatar avatar-md"
                                                    alt="">
                                                <div>
                                        ...
                                        <div class="card-body px-0 py-2">
                                            <a href="{{ url('app-profile-1') }}" class="dropdown-item ai-icon ">
                                        ...
                                        <div class="card-footer px-0 py-2">
                                            ...
                                            <form method="POST" action="{{ route('dashboard.logout') }}"
                                                ...
                                                @csrf
                                                <button type="submit"
                                                    class="btn btn-link d-flex align-items-center p-0 border-0 bg-transparent">
