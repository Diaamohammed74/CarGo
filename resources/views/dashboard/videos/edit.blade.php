            ...
            <div class="col-12">
                <div class="card dz-card" id="accordion-one">
                    <div class="card-header flex-wrap">
                        <div>
                            <h4 class="card-title">Edit Clip</h4>
                        </div>
                    </div>
                        ...
                        <div class="basic-form">
                            ...
                            <div class = "row">
                                ...
                                <div class="mb-3 col-md-12">
                                    ...
                                    <textarea class="form-txtarea form-control" rows="4" id="comment" name="description">{{$video->description}}</textarea>
                                    <x-input-error :messages="$errors->get('description')" class="mt-2" />
                                </div>
                                <div class="mb-3 col-md-6">
                                    <label class="form-label">Category</label>
                                    <div class="dropdown bootstrap-select default-select form-control wide">
                                        <select id="inputState" class="default-select form-control wide" tabindex="null" name="video_category_id">
                                            <option value="">Choose...</option>
                                            @foreach ($categories as $category)
                                            <option value="{{ $category->id }}" {{ $video->video_category_id == $category->id ? 'selected' : '' }}>
                                                {{ $category->title }}
                                            </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="mb-3 col-md-12">
                                    ...
                                    <x-input-error :messages="$errors->get('video')" class="mt-2" />
                                        <div class="mt-2">
                                            <video id="videoPreview" controls style="display: none; max-width: 100%; height: auto;">
