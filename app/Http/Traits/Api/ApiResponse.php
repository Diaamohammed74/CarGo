...
trait ApiResponse
{
    ...
    {
        $message = $message ? __($message) : __('main.success_query');
    ...
    public static function apiResponseRestored($data)
    {
        return self::apiResponse($data, 'main.success_query', 200);
    }
    ...
    public function emptyPaginatedApiResponse()
    {
    ...
    {
        return $this->apiResponse([], __('main.empty'), 200);
    }
